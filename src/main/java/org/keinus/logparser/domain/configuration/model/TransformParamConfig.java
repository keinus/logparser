 ...
 * 각 변환 로직({@link org.keinus.logparser.transform.Filter},
 * {@link org.keinus.logparser.transform.AddProperty},
 * {@link org.keinus.logparser.transform.RemoveProperty})이 필요로 하는
 * 구체적인 설정 값들을 포함합니다.
 *
 * @see TransformConfig
 * @see lombok.Data
